        ...
        a.fn.extend({
            openModal: function(c) {
                ...
                var e = {
                    ...
                    f = a(this);
                f.hasClass("open") || (overlayID = d(), $overlay = a('<div class="lean-overlay"></div>'), lStack = ++b, $overlay.attr("id", overlayID).css("z-index", 1e3 + 2 * lStack), f.data("overlay-id", overlayID).css("z-index", 1e3 + 2 * lStack + 1), f.addClass("open"), a("body").append($overlay), c = a.extend(e, c), c.dismissible && ($overlay.click(function() {
                    f.closeModal(c)
                }), a(document).on("keyup.leanModal" + overlayID, function(a) {
                    27 === a.keyCode && f.closeModal(c)
                })), f.find(".modal-close").on("click.close", function(a) {
                    f.closeModal(c)
                }), $overlay.css({
                    display: "block",
                    opacity: 0
                    ...
                    queue: !1,
                    ease: "easeOutCubic"
                }), f.data("associated-overlay", $overlay[0]), f.hasClass("bottom-sheet") ? f.velocity({
                    bottom: "0",
                    opacity: 1
                }, {
                    duration: c.in_duration,
                ...
                }) : (a.Velocity.hook(f, "scaleX", .7), f.css({
                    top: c.starting_top
                }), f.velocity({
                    top: "10%",
                    opacity: 1,
            ...
            closeModal: function(c) {
                var d = {
                    ...
                    f = e.data("overlay-id"),
                    g = a("#" + f);
                e.removeClass("open"), c = a.extend(d, c), a("body").css("overflow", ""), e.find(".modal-close").off("click.close"), a(document).off("keyup.leanModal" + f),
                    g.velocity({
                        opacity: 0
                    }, {
                    ...
                    f.on("click", function() {
                        ...
                        if ("touch" == d.gesture.pointerType) {
                            ...
                            if ("left" === b.edge && (f > b.menuWidth ? f = b.menuWidth : 0 > f && (f = 0)), "left" === b.edge) f < b.menuWidth / 2 ? h = !1 : f >= b.menuWidth / 2 && (h = !0), e.css("transform", "translateX(" + (f - b.menuWidth) + "px)");
                                ...
                                var i = f - b.menuWidth / 2;
                                0 > i && (i = 0), e.css("transform", "translateX(" + i + "px)")
                            }
                            var j;
            ...
            init: function(b) {
                ...
                return b = a.extend(c, b), this.each(function() {
                    ...
                    function d(a) {
                        ...
                        }), c($caption, b.transition), b.indicators && f.eq(k).removeClass("active"),
                            j.eq(a).velocity({
                                opacity: 1
                            }, {
                                duration: b.transition,
